...
//#define AGE_LENGTH 4   This is not the recommended way *see line 10
...
int main(){
    ...
    std::cout << std::endl;
    std::cout << "Temp[1] = " << temperature[0] << std::endl;
    std::cout << "Temp[2] = " << temperature[1] << std::endl;
    std::cout << "Temp[3] = " << temperature[2] << std::endl;
